...
#import "Config.h"
//#define POPLISTVIEW_SCREENINSET 280.
#define POPLISTVIEW_HEADER_HEIGHT 10.
#define RADIUS 5.
  ...
  /*  if (UIInterfaceOrientationIsLandscape([[UIApplication sharedApplication] statusBarOrientation])) {
    ...
    if (self = [super initWithFrame:rect]) {
       ...
       /* _tableView = [[UITableView alloc] initWithFrame:CGRectMake(POPLISTVIEW_SCREENINSET,
        ...
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(fullScreen.size.width-200, fullScreen.size.height-240, 150, 150)];
...
- (void)drawRect:(CGRect)rect {
    CGRect bgRect = CGRectMake( 0,10, 150, 150);
   // CGRect titleRect = CGRectMake(POPLISTVIEW_SCREENINSET + 10, POPLISTVIEW_SCREENINSET + 10 + 5,
    ...
    float x = fullScreen.size.width-200;
    float y = fullScreen.size.height-250;
