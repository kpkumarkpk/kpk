...
-(CGGradientRef)newGradient
{
    ...
    else if(self.tint == FPPopoverRedTint)
    {
        if(_arrowDirection == FPPopoverArrowDirectionUp)
        {
            colors[0] =  0.01; colors[1] = 0.11; colors[2] = 0.12;
            colors[4] =  0.01; colors[5] = 0.11;  colors[6] = 0.12;
            colors[3] = colors[7] = 1.0;
    ...
    else if(self.tint == FPPopoverGreenTint)
    {
        if(_arrowDirection == FPPopoverArrowDirectionUp)
        {
            //[UIColor colorWithRed:0.071 green:0.035 blue:0.11 alpha:1]
        ...
        {
            colors[0] = 0.071; colors[1] = 0.035; colors[2] = 0.11;
            colors[4] = 0.071; colors[5] = 0.035;  colors[6] = 0.11;
            colors[3] = colors[7] = 1.0;
        }        
    }
...
- (void)drawRect:(CGRect)rect
{
    ...
    {
        CGContextSetRGBFillColor(ctx, 0.01, 0.11, 0.12, 1.0);        
    }
    else if(self.tint == FPPopoverGreenTint)
    {
        CGContextSetRGBFillColor(ctx, 0.071, 0.035, 0.11, 1.0);
    }
    else if(self.tint == FPPopoverWhiteTint)
    {
